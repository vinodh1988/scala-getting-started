error id: file://<WORKSPACE>/callback.scala:[441..441) in Input.VirtualFile("file://<WORKSPACE>/callback.scala", "def bigTaskLibrary(data: String, callback: (String)=> String): Unit= {
