...
parent      = new Project(null: <notype>) # -1,
parent span = <1289..1369>,
child       = null # -1,
child span  = [1301..1371..1371]
...
@main def runTheTraitCompletely  ={
    ...
    val project2:Project = new Project("Java Spring boo TunedMavenBuilding with Deploy
    project2.process
